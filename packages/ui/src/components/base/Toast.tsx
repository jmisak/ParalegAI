...
toast.success = (props: Omit<ToastInput, 'variant' | 'icon'>) =>
  toast({ ...props, variant: 'success', icon: <CheckCircle className="h-5 w-5" /> });

toast.error = (props: Omit<ToastInput, 'variant' | 'icon'>) =>
  toast({ ...props, variant: 'destructive', icon: <AlertCircle className="h-5 w-5" /> });

toast.warning = (props: Omit<ToastInput, 'variant' | 'icon'>) =>
  toast({ ...props, variant: 'warning', icon: <AlertTriangle className="h-5 w-5" /> });

toast.info = (props: Omit<ToastInput, 'variant' | 'icon'>) =>
  toast({ ...props, variant: 'info', icon: <Info className="h-5 w-5" /> });
